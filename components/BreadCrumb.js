    ...
    <>
      <div className="flex items-center h-10 my-1 sm:my-3 lg:my-3 justify-between flex-wrap sm:flex-no-wrap text-sm font-medium">
        ...
        <div className="flex-shrink-0">
          <button
            type="button"
            className={enabledIcon ? "hidden" : "" + " inline-flex rounded-md shadow items-center px-3 py-1 sm:py-2 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150"}
          >
            <svg
            ...
            <span className="">Crea Commericante</span>
